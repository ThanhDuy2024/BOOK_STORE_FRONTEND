        ...
        const loadUserDetail = async () => {
            try {
                const res = await callApi(
                    "get",
                    `${import.meta.env.VITE_REACT_APP_APIDEV}/admin/account/${id}`,
                    {}
                );
                if (res.data) {
    ...
    useEffect(() => {
        const loadRoles = async () => {
            try {
                const res = await callApi(
                    "get",
                    `${import.meta.env.VITE_REACT_APP_APIDEV}/admin/account/roles/list`,
                    {}
                );
                if (res.data) {
                    setRoles(res.data);
        ...
        try {
            ...
            if (res.data.status === true) {
                toast.success(
                    `${lang.formatMessage({
                        id: "users.subtitle",
                    })} ${lang.formatMessage({ id: "toast.updated" })}`
                );
                    ...
                    >
                        ...
                        <fieldset className="fieldset">
                            ...
                            <select
                                id="status"
                                name="status"
                                defaultValue={usersDetail?.status || "active"}
            ...
            <dialog id="my_modal_delete" className="modal">
                <div className="modal-box">
                    <h3 className="text-lg font-bold text-primary">
                        {lang.formatMessage({ id: "book.deleteBook" })}
                    </h3>
                    <p className="py-4">
                        {lang.formatMessage({ id: "book.deleteDes" })}
                    </p>
